...
public class Classe4 extends Veicolo {
	...
	public Classe4(String targa, String modello, int annoImmatricolazione, int assi) {
	...
	public Classe4(String targa, String modello, int annoImmatricolazione, int assi, String classeAmbientale, int inquinamentoAcustico) {
