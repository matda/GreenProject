...
public class PedaggioEco implements IPedaggio {
	...
	public String calcoloPedaggioeco(Veicolo veicolo, Casello puntoPagamentoIn, Casello puntoPagamentoOut, Map<String,Float> tariffaUnitaria, double iva) {return null;} // Throws exception

	// dopo la norma

/**
	public String calcoloPedaggioeco(Veicolo veicolo, Casello caselloIngresso, Casello caselloUscita, Map<String,Float> tariffaUnitaria, double iva) throws IllegalArgumentException {
		String tipoVeicolo;
